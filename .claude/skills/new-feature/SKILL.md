---
name: new-feature
description: Scaffold a new feature in this Flutter project following the feature-first architecture (data/domain/presentation) with Riverpod, Freezed, GoRouter and code generation. Use when the user asks to "add a feature", "create a screen", "scaffold", or build a new module in assiette.
---
